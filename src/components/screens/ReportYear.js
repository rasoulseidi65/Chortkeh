                                ...
                                <Card style={{ marginTop: 10, paddingRight: 10, paddingLeft: 10, backgroundColor: '#fff', height: 55, marginHorizontal: 10 }} key={0}>
                                    <View style={{ flex: 1, flexDirection: 'row' }}>
                                        <View style={{ flex: 3, marginTop: 17, alignItems: 'flex-start', paddingLeft: 8 }}>
                                            ...
                                            <Text style={{ fontSize: 14,color: 'red',fontFamily: 'IRANSansMobile(FaNum)' }}> {this.state.sumOfCost}</Text>
                                ...
                                <Card style={{ marginTop: 10, paddingRight: 10, paddingLeft: 10, backgroundColor: '#fff', height: 55, marginHorizontal: 10 }} key={0}>
                                    <View style={{ flex: 1, flexDirection: 'row' }}>
                                        ...
                                        <View style={{ flex: 3, marginTop: 17, alignItems: 'flex-start', paddingLeft: 8 }}>
                                            ...
                                            <Text style={{ fontSize: 14,color: 'red',fontFamily: 'IRANSansMobile(FaNum)' }}> {this.state.AvgOfDayCost}<Text style={{ fontSize: 14, color: '#777777', fontFamily: 'IRANSansMobile(FaNum)' }}></Text></Text>

                                        </View>
                                        <View style={{ flex: 3, marginTop: 12 }}>

                                            <Text style={{ fontSize: 14,fontFamily: 'IRANSansMobile(FaNum)' }}> میانگین هزینه ها در روز  : </Text>
                                        </View>
                                    </View>
                                </Card>
                            </View>
